...
public class Postre extends javax.swing.JFrame {
    ...
    public void TablaPostres(){
        ...
        TablaPostre.getColumnModel().getColumn(4).setCellRenderer(new ButtonRenderer("/Images/edit.png"));
        TablaPostre.getColumnModel().getColumn(4).setCellEditor(new ButtonEditor(new JCheckBox(), "/Images/edit.png", 4));

        TablaPostre.getColumnModel().getColumn(5).setCellRenderer(new ButtonRenderer("/Images/trash.png"));
        TablaPostre.getColumnModel().getColumn(5).setCellEditor(new ButtonEditor(new JCheckBox(), "/Images/trash.png", 5));
}
    ...
    private void initComponents() {
        ...
        TablaPostre.setBackground(new java.awt.Color(204, 204, 204));
        TablaPostre.setFont(new java.awt.Font("Montserrat Thin", 0, 10)); // NOI18N
